...
if df is not None:
    ...
    tab_oggi, tab_medie, tab_trend = st.tabs(["Oggi (22 Parametri)", "Medie Storiche", "Trend"])
    ...
    with tab_oggi:
        ...
        st.markdown("""
            <div class="metric-card bg-verde">
                ...
                <div class="metric-value">6.004</div>
        ...
        st.markdown("""
            <div class="metric-card bg-verde">
                ...
                <div class="metric-status">🟢 Sbloccato (Circa 1h 36m)</div>
            </div>
        """, unsafe_allow_html=True)
        ...
        st.markdown("""
            <div class="metric-card bg-verde">
                ...
                <div class="metric-status">🟢 Terapia Perfetta (7,5 dec)</div>
            </div>
        """, unsafe_allow_html=True)
